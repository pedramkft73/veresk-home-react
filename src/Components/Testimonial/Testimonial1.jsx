...
const Testimonial1 = () => {
    ...
    return (
        <div className="testimonial-area veresk-testimonial-area">
                                        ...
                                        <div className="testi-content">
                                            ...
                                            <div className="testi-client">
                                                <div className="testi-author">
                                                    <img src={item.image} alt={`${item.title} portrait`} />
                                                </div>
                                                <div className="testi-client-meta">
                                                    <h3 className="testi-title">{item.title}</h3>
                                                    <span className="testi-role">{item.subTitle}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
